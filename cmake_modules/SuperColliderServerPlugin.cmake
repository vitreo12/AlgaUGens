...
function(sc_add_server_plugin dest_dir name cpp sc schelp systemoverwrites)
    if(SCSYNTH)
    ...
    if(systemoverwrites)
        install(FILES ${systemoverwrites} DESTINATION ${dest_dir}/Classes/SystemOverwrites)
    endif()
endfunction()
